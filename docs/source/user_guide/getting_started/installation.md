...
A docker image is also provided on [Docker Hub](https://hub.docker.com/repository/docker/maniskill/base) called  `maniskill/base` and its corresponding [Dockerfile](https://github.com/mani-skill/ManiSkill/blob/main/docker/Dockerfile).
